/*! This file is auto-generated */ ! function(n) {
    ...
    var o, i = t.Backbone,
        ...
        e = (h.VERSION = "1.6.1", h.$ = e, h.noConflict = function() {
        ...
        m = (b.extend(v.prototype, e, {
            ...
            set: function(t, e, i) {
                if (null != t) {
                    ...
                    if (this.idAttribute in n && (r = this.id, this.id = this.get(this.idAttribute), this.id !== r) && this.trigger("changeId", this, r, i), !t) {
        ...
        T = (b.extend(y.prototype, e, {
            ...
            return b.isFunction(e) ? e : b.isObject(e) && !t._isModel(e) ? H(e) : b.isString(e) ? function(t) {
                return t.get(e)
            } : e
        }),
        H = function(t) {
        ...
        R = (b.extend(C.prototype, e, {
            ...
            _routeToRegExp: function(t) {
                return t = t.replace(z, "\\$&").replace(j, "(?:$1)?").replace(O, function(t, e) {
                    return e ? t : "([^/?]+)"
                }).replace(U, "([^?]*?)"), new RegExp("^" + t + "(?:\\?([\\s\\S]*))?$")
            },
        ...
        M = (R.started = !1, b.extend(R.prototype, e, {
            ...
            getFragment: function(t) {
                return (t = null == t ? this._usePushState || !this._wantsHashChange ? this.getPath() : this.getHash() : t).replace(q, "")
            },
            start: function(t) {
            ...
            navigate: function(t, e) {
                ...
                var i = this.root,
                    ...
                    n = (t = t.replace(B, ""), this.decodeFragment(t));
                if (this.fragment !== n) {
        ...
        }), h.history = new R, v.extend = m.extend = C.extend = y.extend = R.extend = function(t, e) {
            var i = this,
