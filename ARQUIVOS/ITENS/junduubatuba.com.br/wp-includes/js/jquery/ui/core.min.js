...
! function(t) {
    ...
    x.cleanData = (o = x.cleanData, function(t) {
        ...
        var n, o, s, r, l = {},
            a = t.split(".")[0];
        return "__proto__" === (t = t.split(".")[1]) || "constructor" === t ? x.error("Invalid widget name: " + t) : (r = a + "-" + t, e || (e = i, i = x.Widget), Array.isArray(e) && (e = x.extend.apply(null, [{}].concat(e))), x.expr.pseudos[r.toLowerCase()] = function(t) {
            return !!x.data(t, r)
        }, x[a] = x[a] || {}, n = x[a][t], o = x[a][t] = function(t, e) {
            ...
            l[e] = "function" != typeof n ? n : function() {
                var t, e = this._super,
                    i = this._superApply;
        ...
        for (var e, i, n = u.call(arguments, 1), o = 0, s = n.length; o < s; o++)
            for (e in n[o]) i = n[o][e], c.call(n[o], e) && void 0 !== i && (x.isPlainObject(i) ? t[e] = x.isPlainObject(t[e]) ? x.widget.extend({}, t[e], i) : x.widget.extend({}, i) : t[e] = i);
        return t
     ...
     */
    W = Math.max, C = Math.abs, s = /left|center|right/, r = /top|center|bottom/, l = /[\+\-]\d+(\.[\d]+)?%?/, a = /^\w+/, h = /%$/, i = x.fn.position, x.position = {
        ...
        var u, d, p, g, m, v, w, y, b, _, t, e;
        return c && c.of ? (v = "string" == typeof(c = x.extend({}, c)).of ? x(document).find(c.of) : x(c.of), w = x.position.getWithinInfo(c.within), y = x.position.getScrollInfo(w), b = (c.collision || "flip").split(" "), _ = {}, e = 9 === (e = (t = v)[0]).nodeType ? {
            width: t.width(),
            height: t.height(),
            offset: {
                top: 0,
            ...
            offset: t.offset()
        }, v[0].preventDefault && (c.at = "left top"), d = e.width, p = e.height, m = x.extend({}, g = e.offset), x.each(["my", "at"], function() {
            var t, e, i = (c[this] || "").split(" ");
            (i = 1 === i.length ? s.test(i[0]) ? i.concat(["center"]) : r.test(i[0]) ? ["center"].concat(i) : ["center", "center"] : i)[0] = s.test(i[0]) ? i[0] : "center", i[1] = r.test(i[1]) ? i[1] : "center", t = l.exec(i[0]), e = l.exec(i[1]), _[this] = [t ? t[0] : 0, e ? e[0] : 0], c[this] = [a.exec(i[0])[0], a.exec(i[1])[0]]
        }), 1 === b.length && (b[1] = b[0]), "right" === c.at[0] ? m.left += d : "center" === c.at[0] && (m.left += d / 2), "bottom" === c.at[1] ? m.top += p : "center" === c.at[1] && (m.top += p / 2), u = E(_.at, d, p), m.left += u[0], m.top += u[1], this.each(function() {
            var i, t, r = x(this),
                l = r.outerWidth(),
                a = r.outerHeight(),
                e = P(this, "marginLeft"),
                n = P(this, "marginTop"),
                o = l + e + P(this, "marginRight") + y.width,
                s = a + n + P(this, "marginBottom") + y.height,
                h = x.extend({}, m),
                f = E(_.my, r.outerWidth(), r.outerHeight());
            "right" === c.my[0] ? h.left -= l : "center" === c.my[0] && (h.left -= l / 2), "bottom" === c.my[1] ? h.top -= a : "center" === c.my[1] && (h.top -= a / 2), h.left += f[0], h.top += f[1], i = {
                marginLeft: e,
                marginTop: n
                ...
                d < l && C(e + i) < d && (s.horizontal = "center"), p < a && C(n + o) < p && (s.vertical = "middle"), W(C(e), C(i)) > W(C(n), C(o)) ? s.important = "horizontal" : s.important = "vertical", c.using.call(this, t, s)
            }), r.offset(x.extend(h, {
                using: t
            }))
    ...
    x.ui.position, x.extend(x.expr.pseudos, {
            data: x.expr.createPseudo(function(e) {
                return function(t) {
                    return !!x.data(t, e)
                }
            })
        ...
        x.ui.focusable = function(t, e) {
            ...
            return "area" === s ? (o = (i = t.parentNode).name, !(!t.href || !o || "map" !== i.nodeName.toLowerCase()) && 0 < (i = x("img[usemap='#" + o + "']")).length && i.is(":visible")) : (/^(input|select|textarea|button|object)$/.test(s) ? (n = !t.disabled) && (o = x(t).closest("fieldset")[0]) && (n = !o.disabled) : n = "a" === s && t.href || e, n && x(t).is(":visible") && "visible" === x(t).css("visibility"))
        }, x.extend(x.expr.pseudos, {
            focusable: function(t) {
                return x.ui.focusable(t, null != x.attr(t, "tabindex"))
            }
        }), x.ui.focusable, x.ui.formResetMixin = {
            ...
            _bindFormResetHandler: function() {
                var t;
                this.form = x(this.element.prop("form")), this.form.length && ((t = this.form.data("ui-form-reset-instances") || []).length || this.form.on("reset.ui-form-reset", this._formResetHandler), t.push(this), this.form.data("ui-form-reset-instances", t))
            },
         ...
         *
         */
        x.escapeSelector || (x.escapeSelector = function(t) {
            return CSS.escape(t + "")
